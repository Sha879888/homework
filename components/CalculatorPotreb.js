...
let CalculatorPotreb = (props) => {
  ...
  const calc = () => {
    ...
    let СуммаКредита = inp.value;
    let СрокИпотеки = inp2.value;
    let ЕжемесячнаяСтавка = 14.5 / 12 / 100;
    ...
    return (
      <div className="Calculator">
        ...
        <TField text="Первоначальный взнос:" size="46" cls="Взнос" divStyle={{opacity: "0"}} inputStyle={{cursor: "default"}} spanStyle={{cursor: "default"}}/>
  ...
  export default CalculatorPotreb;
